...
namespace BinarySearchTrees
{
    class Program
    {
        ...
        private static void VisualizeTree(BinarySearchTree<int> tree, string caption)
        {
            ...
            VisualizeTreeNode(tree.Root, 0, width / 2, console, width);
        ...
        private static void VisualizeTreeNode(BinaryTreeNode<int> node, int row, int column, char[][] console, int width)
        {
            if(node != null)
            {
                ...
                VisualizeTreeNode(node.Left, row + 2, column - columnDelta, console, width);
                VisualizeTreeNode(node.Right, row + 2, column + columnDelta, console, width);
